...
export function bonsARamasser({ achatsLibres = [], projets = [], fournisseurs = [], bcEstRamassage }) {
...
export function calculerTournees(bons) {
  ...
  Object.values(parCle).forEach((t) => {
    ...
    t.arrets = arrets;
    t.signature = JSON.stringify(t.bons.map((b) => [b.numero, b.fournisseur, b.depotA, b.texte.slice(0, 200), b.pourJob]));
