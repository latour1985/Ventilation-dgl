...
export async function listerEntreprisesPlateforme() {
  const { data, error } = await supabase
    .from("entreprises")
    .select("id, nom_legal, nom_commercial, courriel, statut_plateforme, gratuit_jusqua, suspendue, created_at, modules, prix_base, sieges_inclus, prix_par_siege, rabais_pourcent, promo_pourcent, promo_mois")
    .order("created_at");
