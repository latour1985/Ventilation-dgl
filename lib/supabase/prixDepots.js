...
// 👥 APPEL À 2 HOMMES (2026-09-04, règle du propriétaire) : dès que
// l'appel compte 2 techniciens facturables, le prix de zone et le temps
// inclus ne s'appliquent PLUS — chaque homme est facturé
// max(minimum, son aller-retour + son temps sur place) : le chauffeur
// au taux vendant, l'assistant (passager) au taux vendant moins le
// camion. La valeur est le MINIMUM D'HEURES (défaut 3).
export const CLE_MIN_HEURES_2_HOMMES = "minimum_heures_2_hommes";
// 🔧 TEMPS & MATÉRIEL à 2 hommes FACTURABLES (2026-09-04, règle du
// propriétaire) : minimum d'heures PAR HOMME (défaut 3). À un seul
// homme facturable : heures réelles, aucun minimum.
export const CLE_MIN_HEURES_2_HOMMES_TM = "minimum_heures_2_hommes_tm";

// Les clés de CONFIGURATION (pas des zones).
export const CLES_CONFIG_DEPOTS = [CLE_TAUX_VENDANT, CLE_MINUTES_INCLUSES, CLE_MINUTES_HORS_ZONE, CLE_MIN_HEURES_2_HOMMES, CLE_MIN_HEURES_2_HOMMES_TM];
