...
import { tauxPourCourriel } from "./tauxMetiers";
...
export async function enregistrerTravailEffectue(infos, session) {
  ...
  let tauxFige = null;
  try {
    // Le SECTEUR de la tâche choisit la colonne de la grille CCQ.
    tauxFige = await tauxPourCourriel(email, infos.secteur === "residentiel" ? "residentiel" : "commercial");
  } catch {
