...
export async function sauvegarderEntreprise(c) {
  ...
  if (error && (error.code === "PGRST204" || /qb_lecture_depuis|logo_donnees|achats_seulement_bc|courriel_copie_bc|lien_avis_google|systeme_comptable/.test(error.message || ""))) {
    const { qb_lecture_depuis: _ignore1, logo_donnees: _ignore2, achats_seulement_bc: _ignore3, courriel_copie_bc: _ignore4, lien_avis_google: _ignore5, systeme_comptable: _ignore6, ...sansColonnesRecentes } = champs;
