...
export async function sauvegarderEntreprise(c) {
  ...
  if (error && (error.code === "PGRST204" || /qb_lecture_depuis|logo_donnees|achats_seulement_bc/.test(error.message || ""))) {
    const { qb_lecture_depuis: _ignore1, logo_donnees: _ignore2, achats_seulement_bc: _ignore3, ...sansColonnesRecentes } = champs;
