...
export async function creerAchatLibre({ numeroBc, fournisseurNom, description, montantHT, dateAchat, tacheId, tacheTitre, clientId, clientNom, montantAttribue, livraisonSouhaitee = null }, session) {
  const base = {
