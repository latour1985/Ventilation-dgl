...
export const DICO_EN = {
  ...
  "projets avec activité · cliquer pour l'analyse": "projects with activity · click for analysis",
  "aucun projet commencé · cliquer pour l'analyse": "no project started yet · click for analysis",
  "À faire aujourd'hui": "To do today",
  "Bien démarrer avec Fluxya": "Getting started with Fluxya",
  "Configurer": "Set up",
  "journée terminée": "day complete",
  "tâche à faire": "task left",
  "tâches à faire": "tasks left",
  "sans date — à confirmer": "no date — to confirm",
  ...
  "Mets en pause «": "Pause «",
  "» avant de commencer celle-ci — une seule tâche en cours à la fois.": "» before starting this one — only one task running at a time.",
  ...
  // ---- Tableau de bord : livraisons (2026-09-15) ----
  "Livraisons attendues": "Expected deliveries",
  "cette semaine": "this week",
  "en retard": "late",

  // ---- Technicien : « En route » (2026-09-14) ----
  "Client averti à": "Customer notified at",
  "arrivée prévue dans": "expected arrival in",
  "« En route » indisponible : aucun courriel au dossier de ce client.": "\"On my way\" unavailable: no email on file for this customer.",
  "« En route » indisponible : aucun téléphone ni courriel au dossier de ce client.": "\"On my way\" unavailable: no phone or email on file for this customer.",
  "Avertir le client que tu es en route": "Let the customer know you're on your way",
  "Par texto (de ton téléphone) au": "By text (from your phone) to",
  "…ou par courriel à": "…or by email to",
  "Un courriel part à": "An email goes to",
  "choisis ton délai :": "pick your ETA:",
  "Hors ligne — réessaie dès que le réseau revient.": "Offline — try again as soon as the network is back.",
  "Courriel hors ligne — utilise le texto, ou réessaie dès que le réseau revient.": "Email offline — use the text option, or try again once the network is back.",
  "Visite pour soumission — formulaire allégé": "Estimate visit — simplified form",
  "Note ce que tu as observé et les mesures utiles au devis. Photos facultatives. Aucune signature, rien ne part en facturation.": "Write down what you observed and the measurements needed for the quote. Photos optional. No signature, nothing goes to billing.",
  "Envoi impossible — réessaie.": "Could not send — try again.",

  // ---- Devis (tranche admin, 2026-09-14) ----
  "Nouveau devis": "New quote",
  "Modification en cours": "Editing",
  "Créer le devis": "Create the quote",
  "Créer le contrat d'entretien périodique": "Create the recurring maintenance contract",
  "✉️ Envoyer au client": "✉️ Send to client",
  "✉️ Renvoyer la copie au client": "✉️ Resend the copy to client",

  // ---- Facturation (tranche admin, 2026-09-14) ----
  "À réviser — prix non listé": "To review — unlisted price",
  "À valider — selon devis": "To validate — from quote",
  "À valider — contrat": "To validate — contract",
  "Prêts — bon de commande": "Ready — purchase order",
  "Appels de service": "Service calls",
  "Retirés — garantie / maison / hors Fluxya": "Removed — warranty / in-house / outside Fluxya",
  "✅ Déjà facturés": "✅ Already invoiced",
  "À réviser": "To review",
  "prix à fixer avant la facture": "price to set before invoicing",
  "Prêts à facturer": "Ready to invoice",
  "prix validé, pas encore envoyé": "price validated, not sent yet",
  "Retirés": "Removed",
  "garantie / maison / hors Fluxya": "warranty / in-house / outside Fluxya",
  "hors de la liste — un clic les montre": "hidden from the list — click to show",
  "📋 À facturer — par client et par projet": "📋 To invoice — by client and project",
  "Une vente au comptoir, un contrat, des frais ? Une facture peut partir sans chantier.":
    "A counter sale, a contract, fees? An invoice can go out without a job site.",
  "Nouvelle facture": "New invoice",
  "✉️ Envois par QuickBooks : aucun problème connu": "✉️ QuickBooks sending: no known issue",
  "Vérification…": "Checking…",
  "🔎 Vérifier les envois": "🔎 Check the sendings",
  "💵 Comptes à recevoir": "💵 Accounts receivable",
  "⏱️ Temps de paiement par client": "⏱️ Payment time by client",
