# Entente de partenaire fondateur

> **BROUILLON — à faire réviser par un avocat avant toute signature.**
> Entente entre entreprises (B2B) — rédigée le 15 août 2026.
> S'accompagne de l'**Annexe A — Protection des données** (document séparé, signé en même temps).

**ENTRE :** Ventilation DGL inc. (ou l'entité qui lui succédera pour l'exploitation du logiciel), ci-après « **l'Exploitant** »

**ET :** ______________________________________ (l'entreprise utilisatrice), ci-après « **le Fondateur** »

## 1. Objet

L'Exploitant donne au Fondateur accès à son logiciel de gestion d'entreprise de services (applications bureau et mobile, ci-après « le Logiciel »), avec l'ensemble des modules disponibles, en version d'amélioration continue (« rodage »). Le Fondateur agit comme partenaire de test : il utilise le Logiciel dans ses opérations réelles et contribue à son amélioration.

## 2. Gratuité de la première année
...
- En contrepartie, le Fondateur s'engage à : (a) utiliser réellement le Logiciel dans ses opérations ; (b) fournir un retour d'usage au moins une fois par mois (appel, liste de points ou signalements) ; (c) signaler les anomalies rencontrées. Si le Fondateur cesse d'utiliser le Logiciel ou de fournir ses retours pendant plus de soixante (60) jours, l'Exploitant peut mettre fin à la gratuité après un avis écrit de quinze (15) jours.

## 3. Prix fondateur — 25 % à vie
...
## 4. Propriété intellectuelle — interdiction de copie
...
## 7. Version en rodage — garanties limitées
...
- L'entente prend effet à la signature et se poursuit tant que l'abonnement est actif.
...
**L'Exploitant — Ventilation DGL inc.**

Par : ______________________________ Date : ______________

**Le Fondateur — _______________________________**

Par : ______________________________ Date : ______________

*Annexe A — Protection des données : signée le même jour (document joint).*
